...
namespace AuldShiteburn.MapData.TileData.Tiles.NPCs
{
    ...
    class OrmodNPCTile : NPCTile
    {
        ...
        protected override void InitLines()
        {
            ...
            stage1EarhRequest.Add(new InteractionData(Dialogue("Bless you, stranger. I had a friend, Earh. He and I were separated in the Residence.")));
            ...
            stage1Interim.Add(new InteractionData(Dialogue("You should find the Residence in the East. But be wary, unimaginable filth roams this village.")));
